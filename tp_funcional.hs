...
incrementarPC microprocesador = microprocesador {(+1).programCounter microprocesador}

nop microprocesador = microprocesador {programCounter = incrementarPC microprocesador}
